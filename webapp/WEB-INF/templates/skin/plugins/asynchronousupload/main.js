...
//				{
        ...
        strContent = strContent + "<div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">" +((((jsonData.fileCount == 1)&&(jsonData.files.preview!=""))||((jsonData.fileCount > 1)&&(jsonData.files[index].preview!=""))) ? " <img src=" + "'" + ((jsonData.fileCount == 1) ? jsonData.files.preview : jsonData.files[index].preview) + "'" + "alt='' " + " width='${previewMaxWidth}' height='${previewMaxHeight}'/>" : "" )+"</div>" + "<label class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">  \
								<input type=\"checkbox\"  \
									name=\"" + checkboxPrefix + index + "\"  \
									id=\"" + checkboxPrefix + index + "\"  \
								/>  \
								&#160;" + ((jsonData.fileCount == 1) ? jsonData.files.name : jsonData.files[index].name) +" </label></div>";
//				}
